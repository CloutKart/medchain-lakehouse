...
# MAGIC %md
# MAGIC # MedChain — Data quality scorecard
# MAGIC
...
# Blocking failures raise, which fails the notebook, which fails the ADF activity.
# That is the intended chain: a warehouse that fails its own integrity checks must
# not be quietly published to the dashboard.
results = scorecard.run(spark, cfg, logical_date, fail_on_blocking=True)
